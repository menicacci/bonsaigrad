...
def embedding_normal(rng: np.random.Generator, num_embeddings: int, embedding_dim: int) -> np.ndarray:
    return rng.normal(scale=embedding_dim ** -0.5, size=(num_embeddings, embedding_dim))
